...
public class Alumno {
    //DECLARAR VARIABLES DE INSTANCIA(ATRIBUTOS)
    ...
    public List<String> getAsignatures_al() {
        return asignaturas_al;
    }

    public void setAsignatures_al(List<String> asignatures_al) {
        this.asignaturas_al = asignatures_al;
    }
    ...
    public String toString() {
        return "Alumno{" + "idAlumno=" + idAlumno + ", nombre=" + nombre + ", apellido=" + apellido + ", edad=" + edad + ", asignatures_al=" + asignaturas_al + '}';
    }
    public static String cabecera(){
        String c = String.format("%-2s %-6s %-8s\n","ID","NOMBRE","APELLIDO");
        return c;   
    }
     public static String SubrayadoCabecera(){
        String c = String.format("%-2s %-6s %-8s\n","--","------","--------");
        return c;   
    }
    public String cuerpo(){
        String c = String.format("%-2s %-6s %-8s %5d\n",idAlumno,nombre,apellido,  edad);
        return c;
    }
    //OTROS METODOS
    public void entrada(List<Alumno> alumnos_al){
        ...
        if(!Util.existeIdAumno(idAlumno, alumnos_al)){
            ...
            //edad = sc.nextInt();
            int n = Util.leerNumeroAsignaturas();
